...
<nav class="navbar navbar-default navbar-fixed-top">
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src='<c:url value="resources/img/ncs.jpg"></c:url>' alt="Chicago"
					style="width: 100%; height: 700px">
				<div class="carousel-caption">

					<button
						style="background-color: #18d26e; margin-bottom: 15%; padding: 0px; font-weight: 700; font-size: 14px; height: 36px; -moz-border-radius: 8px; -webkit-border-radius: 3px; border-radius: 18px; border: none;">
					...
					<h2 style="color: white-space;"><b>THINK IT THINK US</b></h2>
			...
			<div class="item">
				...
				<div class="carousel-caption">
					...
					<br> <br>
					<h2 style="color: blue;"><b>Your Performance is your job
						guarantee</b></h2>
	...
	<div class="container-fluid p-0">
		<div class="row no-gutters popup-gallery">
			...
			<div class="col-lg-4 col-sm-6">
				<a class="portfolio-box" href='<c:url value="resources/img/bs.jpg"></c:url>'>
					<img class="img-fluid" style="width: 410px; height: 250px"
