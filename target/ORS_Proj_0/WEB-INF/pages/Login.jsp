...
<!-- <body style="background-image: url('http://localhost:8080/ORS_Proj_0/resources/images/Back.jpg')">
 -->
 <body
	style="background-image: url('<c:url value="http://localhost:8080/ORS_Proj_0/resources/Back4.jpg" />');">

 	<sf:form method="post" commandName="form">
		<div class="container">

			<div class="card card-container" style="max-width: 500px;background-image: url('<c:url value="http://localhost:8080/ORS_Proj_0/resources/Back4.jpg" />');">
				<div align="center" style="font-style: italic; color: black;">
					<h3 style="color: #1990EE;">
...
<s:message code="label.password" var="password"></s:message>
				...
				&nbsp; &nbsp;&nbsp; <br> <a style="color: white;"
					href='<c:url value="/ForgetPassword"/>' class="forgot-password"><s:message code="login.lebel.forgetMyPassword"></s:message> </a>&nbsp;|&nbsp;<a style="color: white;"
					href='<c:url value="/SignUp" />' class="forgot-password"><s:message code="login.lebel.userRegistration"></s:message> </a>
