...
<body style="background-image: url('<c:url value="http://localhost:8080/ORS_Proj_0/resources/img/n8.jpg" />');">
				...
				<ul class="nav navbar-nav navbar-left">
					<c:if test="${not empty sessionScope.user}">
						<c:if test="${sessionScope.user.roleId == 1}">
							<li class="dropdown"><a
								style="color: white; background-color: #2d2d30;"
	...
	<table width=100%>
		...
		<tr>
			<td colspan="2" style="text-align: left;">
			 <a class="btn btn-primary" href="?lang=en">English</a>  <a class="btn btn-primary" href="?lang=hi"><s:message code="lable.hindi"></s:message> </a>
