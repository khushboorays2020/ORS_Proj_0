...
<body>
	...
	<div class="container text-center">
		<h2 class="text-primary" style="color: black; font-style: italic;">
			<b><s:message code="timetable.label.timeTableList"></s:message> </b>
		</h2>
	</div>
	<br>
		...
		<c:choose>
			...
			<c:otherwise>
				...
				<div class="form-inline" align="center">
					...
					<label class="control-label col-sm-2" style="text-align: right;"><b><s:message
								code="timetable.label.subject" />: </b></label>
					<div class="col-sm-2">
					...
					<label class="control-label col-sm-2" style="text-align: right;"><b><s:message
								code="timetable.label.course"></s:message>: </b></label>
					<div class="col-sm-2">
				...
				<div class="table-responsive">
					<table class="table" height="40%" border="1"
						...
						<tr align="center" bgcolor="teal">
							...
							<th><s:message code="timetable.label.course" /></th>
							<th><s:message code="timetable.label.subject"></s:message></th>
							<th><s:message code="timetable.label.semester" /></th>
							<th><s:message code="timetable.label.examDate"></s:message>
							</th>
							<th><s:message code="timetable.label.examTime" /></th>
						...
						<c:forEach items="${list}" var="timeTable" varStatus="ct">
							<tr>
								...
								<td><c:out value="${timeTable.semester}" /></td>
								<td><fmt:formatDate value="${timeTable.examDate}"/> </td>
								
								<td><c:out value="${timeTable.examTime}" /></td>

								<td><a href="${editUrl}${timeTable.id}"
				...
				<div>
					<div class="form-inline" align="center">
						...
						<div class="col-sm-offset col-sm-3">
							<a class="btn btn-info" href='<c:url value="/ctl/TimeTable" />'><span
						...
						<c:choose>
							<c:when test="${list.size()==form.pageSize && !((timetableList.size()==form.pageSize*form.pageNo))}">
								<div class="col-sm-offset col-sm-3">
									<button type="submit" class="btn btn-primary" name="operation"
										 value="Next">
