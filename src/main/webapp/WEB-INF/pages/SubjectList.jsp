...
<body>
	...
	<div class="container text-center">
		<h2 class="text-primary" style="color: black; font-style: italic;">
			<b><s:message code="subject.label.subjectList"></s:message> </b>
		</h2>
	</div>
	<br>
...
<s:message code="subject.placeholder.name" var="name"></s:message>
					...
					<div class="col-sm-2">
						<sf:input path="name" class="form-control" style="width: 100%"
							name="subjectName" placeholder="${name }" />
					</div>
					<label class=" col-sm-1" style="text-align: right;"><b><s:message
								code="subject.label.course" />:</b></label>
					<div class="col-sm-2">
				...
				<div class="table-responsive">
					<table class="table" height="40%" bgcolor="" border="1"
						...
						<tr align="center" bgcolor="teal">
							...
							<th><s:message code="subject.label.course"></s:message></th>
						...
						<c:forEach items="${list}" var="subject" varStatus="ct">
							<tr>
								...
								<td><input type="checkbox" name="ids" value="${subject.id}"></td>
								<td><c:out
								...
								<td><a href="${editUrl}${subject.id}" style="color: blue;"><span
				...
				<div>
					<div class="form-inline" align="center">
						...
						<div class="col-sm-offset col-sm-3">
							<a class="btn btn-info" href='<c:url value="/ctl/Subject" />'><span
						...
						<c:choose>
							<c:when test="${list.size()==form.pageSize && !((subjectList.size()==form.pageSize*form.pageNo))}">
								<div class="col-sm-offset col-sm-3">
									<button type="submit" class="btn btn-primary" name="operation"
										 value="Next">
