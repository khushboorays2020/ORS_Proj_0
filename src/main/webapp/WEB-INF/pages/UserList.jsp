...
<s:message code="user.placeholder.firstName" var="firstName"></s:message>
				...
				<div align="center">
					...
					<label class=" col-sm-2"><b><s:message
...
<s:message code="user.placeholder.login" var="login"></s:message>
					...
					<label class=" col-sm-1" for="login"><b><s:message
								code="user.label.login" />:</b></label>
					<div class="col-sm-2">
						<sf:input path="login" class="form-control" style="width: 100%"
							placeholder="${login }" />
					</div>

					<label class="col-sm-1"><b><sf:label path="roleId">
						...
						<c:if test="${!empty list}">
							...
							<c:forEach items="${list}" var="user" varStatus="ct">
								...
								<c:choose>
									...
									<c:otherwise>
									<td><a href="${editUrl}${user.id}" style="color: blue;"><span
